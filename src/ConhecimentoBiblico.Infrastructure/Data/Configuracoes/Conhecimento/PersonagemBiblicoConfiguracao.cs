...
public class PersonagemBiblicoConfiguracao : IEntityTypeConfiguration<PersonagemBiblico>
{
    public void Configure(EntityTypeBuilder<PersonagemBiblico> builder)
    {
        ...
        builder.HasData(
            ...
            new { Id = DadosIniciais.IdJoaoBatista,  Nome = "João Batista",  Descricao = "Profeta que preparou o caminho do Senhor e batizou Jesus no Rio Jordão (Mateus 3).",     TipoElemento = TipoElementoBiblico.Personagem, ElementoCentral = false, PeriodoHistorico = "Século I d.C.",    Ocupacao = "Profeta, Precursor"           }
        );
    }
}
